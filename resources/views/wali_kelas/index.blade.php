...
<div class="main-content">
    <main>
        <form action="{{ url('wali_kelas') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            @csrf
...
<div class="main-content">
    <main>
        <a href="{{ route('wali_kelas.create') }}" class="d-none d-sm-inline-block btn btn-sm text-white  shadow-sm" style="background-color: #256D85;"><i
