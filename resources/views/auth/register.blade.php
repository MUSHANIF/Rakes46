      ...
      <div class="w-full md:w-1/2 lg:w-1/3 p-5 bg-white shadow-2xl border md:rounded-lg md:rounded-l-none md:h-[75vh] md:flex md:flex-col md:justify-center">
         ...
         <form action="{{ route('register') }}" method="post">
            ...
            <div class="mb-4">
               ...
               <input type="text" class="w-full px-4 py-2 rounded-lg focus:outline-none placeholder:text-slate-600/50 placeholder:text-sm text-slate-800 focus:ring form-normal @error('name') form-invalid @enderror" placeholder="Input Your Username" id="name" name="name" value="{{ old('name') }}">
               @error('name')
            ...
            <div class="mb-4">
               ...
               <input type="email" class="w-full px-4 py-2 rounded-lg focus:outline-none placeholder:text-slate-600/50 placeholder:text-sm text-slate-800 focus:ring form-normal @error('email') form-invalid @enderror" placeholder="Input Your Email" id="email" name="email" value="{{ old('email') }}">
               @error('email')
                  <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                     {{ $message }}
                  </p>
            ...
            <div class="md:mb-2 mb-4 ">
               ...
               <input type="password" class="w-full px-4 py-2 rounded-lg focus:outline-none placeholder:text-slate-600/50 placeholder:text-sm text-slate-800 focus:ring form-normal @error('password') form-invalid @enderror" placeholder="Input Your Password" id="password" name="password">
               @error('password')
                  <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                  {{ $message }}
                  </p>
            ...
            <div class="md:mb-2 mb-4 ">
               ...
               <input type="password" class="w-full px-4 py-2 rounded-lg focus:outline-none placeholder:text-slate-600/50 placeholder:text-sm text-slate-800 focus:ring form-normal @error('password_confirmation') form-invalid @enderror" placeholder="Input Your Confirm Password" id="confirm_password" name="password_confirmation">
