                ...
                <div class="container">
                    ...
                    @if (!empty($ortu))
                        <main>
                            <div>
                                <h2
                                    class="my-10 font-semibold text-center text-gray-700 dark:text-gray-200 text-2xl md:text-3xl">
                                    Detail Informasi Anda</h2>

                                <div class="mb-2">
                                    <div class="md:flex gap-x-6">
                                        <div
                                            class="text-gray-800 text-sm font-normal w-full px-4 py-4 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-200 dark:text-gray-100">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <div class="grid grid-cols-2">
                                                    ...
                                                    <h5 class="text-base md:text-lg lg:text-xl capitalize">:
                                                        {{ $ortu->nama_ayah }}</h5>
                                                </div>
                                                <div class="grid grid-cols-2">
                                ...
                                <div
                                    ...
                                    <div class="flex justify-between mb-2.5">
                                        ...
                                        <span
                                            class="text-sm font-medium text-blue-700 dark:text-white">{{ $persentasi }}%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                                        <div class="bg-blue-600 h-1.5 rounded-full" style="width: {{ $persentasi }}%">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-3 gap-x-2 gap-y-12">
                                            ...
                                            @if ($jawabans->isNotEmpty() && !empty($jawabans['1']['a']) && $jawabans['1']['a']->count() == $jumlahGroupA)
                                                <div class="w-full">
                                                    ...
                                                    <button class="text-black mt-3 relative w-full text-start"
                                                        ...
                                                        <div data-popover id="popover-groupA1" role="tooltip"
                                                            class="inline-block absolute invisible z-10 w-52 md:w-64 text-sm font-light text-gray-500 bg-white rounded-lg border border-gray-200 shadow-sm opacity-0 transition-opacity duration-300 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
                                                            <div
                                                            ...
                                                            <div class="p-3 flex gap-x-2">
                                                                <a href="/isijawaban/1/a"
                                                                    class="flex pt-0 items-center gap-x-1 text-xs md:text-sm  font-semibold text-slate-700 hover:text-blue-600">
                                                                    <i data-feather="align-right" class="w-5"></i>
                                                                    Detail
                                                                </a>
                                                                <a href="/editjawaban/1/a"
                                                                    class="flex pt-0 items-center gap-x-1 text-xs md:text-sm font-semibold text-slate-700 hover:text-cyan-500">
                                                ...
                                                <div class="w-full">
                                                    ...
                                                    <button class="text-black mt-3 relative w-full text-start"
                                                        ...
                                                        <div data-popover id="popover-groupA1" role="tooltip"
                                                            ...
                                                            <div class="p-3 flex gap-x-2">
                                                                <a href="/kuisioner"
                                                                    class="flex items-center gap-x-1 text-xs md:text-sm text-slate-700 hover:text-blue-600">
