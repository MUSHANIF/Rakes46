        ...
        <main>
            ...
            @elseif (Auth::user()->level == 5)
                <form action="{{ url('siswa') }}" method="GET" class="">
                    @csrf
                    <div class="input-group">
                        <input type="text" class="form-control bg-light" placeholder="Search for..." name="cari"
                            value="{{ request('cari') }}" />
                        <div class="input-group-append">
                            <button class="btn" style="background-color: #256d85" type="submit">
                                <i class="fas fa-search fa-sm text-white"></i>
                    ...
                    <div class="container" style="position: relative">
                        ...
                        <form action="{{ route('siswawali.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="StoreID" name="nip"
                                    placeholder="1345478434" required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="LocID" placeholder="Udin Bahrudin"
                                    name="nama_guru" required />
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput">Tahun Ajaran</label>
                                <input type="number" class="form-control" id="ProdID" name="thn_ajaran" placeholder="2022"
                                    required
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                            ...
                            <select class="form-select" aria-label="Default select example" name="jurusan" required>
                                @foreach ($kelasguru as $guru2)
                                    <option value="{{ $guru2->jurusan }}">{{ $guru2->jurusan }}</option>
                                @endforeach
                            </select>
                            <button style="background-color: #1960a7; border: unset" type="submit"
                                class="btn btn-primary mt-4">Submit</button>
                            <button type="reset" class="btn btn-danger border-0 mt-4"
                                style="background-color: #dc3545">Reset</button>
                        </form>
                    </div>
                @endif
            @endcan
                                ...
                                <tbody>
                                    <tr class="align-self-center" style="border: 1px solid rgba(0, 0, 0, 0.4)">
                                        ...
                                        <td data-label="Jenis kelamin">
                                            {{ $key->jns_kelamin == 'L' ? 'Laki-Laki' : 'Perempuan' }}</td>
                                        <td class="text-center justify-content-center align-self-center d-flex">
                                            <a class="btn btn-detail border-0 ml-2"
                                                href="{{ route('siswawali.show', $key->userID) }}">Detail</a>
                                        </td>
                                    </tr>
                                </tbody>
                            @endforeach
                                ...
                                <tr class="align-self-center" style="border: 1px solid rgba(0, 0, 0, 0.4)">
                                    ...
                                    <td class="text-center justify-content-center align-self-center d-flex">
                                        @if (Auth::user()->level == 3)
                                            <a class="btn btn-detail border-0 ml-2"
                                                href="{{ route('siswapuskesmas.show', $key->id) }}">Detail</a>
                                        @elseif (Auth::user()->level == 4)
                                            <a class="btn btn-detail border-0 ml-2"
                                                href="{{ route('siswakepala.show', $key->id) }}">Detail</a>
                                        @endif
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <tr class="align-self-center" style="border: 1px solid rgba(0, 0, 0, 0.4)">
                                    ...
                                    <td class="text-center justify-content-center align-self-center d-flex">
                                        <a class="btn btn-info text-light border-0"
                                            href="{{ route('siswa.edit', $key->id) }}">Ubah</a>
                                        ...
                                        <a class="btn btn-detail border-0 ml-2"
                                            href="{{ route('siswa.show', $key->id) }}">Detail</a>
                                    </td>
                                </tr>
                            </tbody>
                        @endforeach
