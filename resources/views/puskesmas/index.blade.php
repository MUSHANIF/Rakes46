...
@section('button')
    <a href="{{ route('puskesmas.create') }}" class="d-none d-sm-inline-block btn btn-sm text-white shadow-sm"
        style="background-color: #256d85"><i class="fas fa-download fa-sm text-white"></i> Tambah</a>
@endsection
...
@section('isi')
    <div class="main-content">
        <main>
            <div class="container">
                <h2 class="my-6 text-2xl font-semibold text-gray-700">List Puskesmas</h2>
                                ...
                                <td class="justify-content-center align-self-center d-flex text-center">
                                    @can('superadmin')
                                        <a class="btn btn-info text-light border-0"
                                            href="{{ route('puskesmas.edit', $key->id) }}">Ubah</a>
                                    ...
                                    @else
                                        <a class="btn btn-detail ml-2 border-0" onclick="showbutton()">Detail</a>
                                    @endcan
                                </td>
                            </tr>
                        </tbody>
